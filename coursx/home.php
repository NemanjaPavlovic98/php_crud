...
if (!$result) {
    echo "Nastala je greska pri izvođenju upita<br>";
    die();
}
...
<div class="menu-section row">
    <div class="col-md-4 menu-section-item">
        <h2 style="font-weight: 600; color: white">Courses overview</h2>
        <p style="color: rgba(255,255,255,.5)">See all the courses:</p>
        <button id="btn" class="btn btn-info btn-block"
                ><i
                    class="glyphicon glyphicon-th-list"></i> Overview
        </button>
    </div>
    <div class="col-md-4 menu-section-item"><h2 style="font-weight: 600; color: white">Add new</h2>
    ...
    <div class="col-md-4 menu-section-item"><h2 style="font-weight: 600; color: white">Search</h2>
        <p style="color: rgba(255,255,255,.5)">Search by a keyword: </p>
        
        <input type="text" id="myInput" class="forma1" 
        style="display:none" onkeyup="funkcijaZaPretragu()" placeholder="Search courses">
        
        <button id="btn-pretraga" class="btn btn-warning btn-block" onclick="showSearch()">
    ...
    <div class="panel-body">
        ...
        <div class="row" style="padding: 1%">
            <div class="col-md-12" style="text-align: right">
                <button id="btn-izmeni" class="btn btn-warning"
                        data-toggle="modal" data-target="#izmeniModal"><i
                            class="glyphicon glyphicon-pencil"></i> Izmeni
                </button>
                <button id="btn-obrisi" class="btn btn-danger"><i
                        ...
                        <div class="update-form-row">
                            <div class="col-md-6" style="width:100%">
                                <div class="form-group">
                                    <input type="text" style="border: 1px solid black" name="nazivKursa" class="form-control"
                                           placeholder="Course name *" value="<?php echo $red["id"] ?>"/>
                                </div>
                                <div class="form-group">
                                    <input type="text" style="border: 1px solid black" name="provajderKursa" class="form-control" placeholder="Provajder kursa *"
                                           value=""/>
                                </div>
                                <div class="form-group">
                                    <input type="number" style="border: 1px solid black" name="cenaKursa" class="form-control"
                                           placeholder="Course price *" value=""/>
                                </div>
                                
                            </div>
                            <div class="col-md-6" style="width:100%">
                                <div class="form-group">
                                    <textarea name="opisKursa" class="form-control" placeholder="Short cource description *"
                                    style="width: 100%; height: 150px; border: 1px solid #cd2633; resize:none"></textarea>
                                </div>
                                <div class="form-group">
                                    <button id="btnDodaj" type="submit" class="btn btn-success btn-block"
                                    style="background-color: #cd2633; border: 1px solid #cd2633; resize:none"><i
                                    class="glyphicon glyphicon-plus"></i> Add cource</button>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input id="id" type="text" name="idSira" class="form-control"
                                           placeholder="Cource id *" value="" readonly/>
                                </div>
                                <div class="form-group">
                                    <input id="nazivv" type="text" name="nazivKursa" class="form-control"
                                           placeholder="Course name *" value=""/>
                                </div>
                                <div class="form-group">
                                    <input id="zemljaa" type="text" name="provajderKursa" class="form-control"
                                           placeholder="Course provider *" value=""/>
                                </div>
                                <div class="form-group">
                                    <input id="cijenaa" type="number" name="cenaKursa" class="form-control"
                                           placeholder="Cource price *" value=""/>
                                </div>
                                
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <textarea id="opiss" name="opisKursa" class="form-control"
                                    placeholder="Course desc *"
                                    style="width: 100%; height: 150px;"></textarea>
                                </div>
                                                            <div class="form-group">
                                                                <button id="btnIzmeni" type="submit" class="btn btn-success btn-block"
                                                                        style="color: white; background-color: #8b1c25; border: 1px solid #8b1c25"><i
                                                                            class="glyphicon glyphicon-pencil"></i> Change course
                                                                </button>
                                                            </div>
                            </div>
                        </div>
